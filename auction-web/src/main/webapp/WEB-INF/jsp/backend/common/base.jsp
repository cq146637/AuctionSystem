...
<head>
    ...
    <link rel="stylesheet" href="../assets/libs/AdminLTE-2.4.5/dist/css/skins/_all-skins.min.css">
    <!-- Morris chart -->
    <link rel="stylesheet" href="../assets/libs/AdminLTE-2.4.5/bower_components/morris.js/morris.css">
    <!-- jvectormap -->
    <link rel="stylesheet" href="../assets/libs/AdminLTE-2.4.5/bower_components/jvectormap/jquery-jvectormap.css">
    <!-- Date Picker -->
    ...
    <link rel="stylesheet" href="../assets/libs/AdminLTE-2.4.5/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
